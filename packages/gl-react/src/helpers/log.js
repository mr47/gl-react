...
isOpera = function() {
    return navigator && /OPR/.test(navigator.userAgent) && /Opera/.test(navigator.vendor);
};

isFF = function() {
    return navigator && /Firefox/.test(navigator.userAgent);
};

isIE = function() {
    return navigator && /MSIE/.test(navigator.userAgent);
};

safariSupport = function() {
    var m;
    m = navigator && navigator.userAgent.match(/AppleWebKit\/(\d+)\.(\d+)(\.|\+|\s)/);
    if (!m) {
        return false;
    }
...
operaSupport = function() {
    var m;
    m = navigator && navigator.userAgent.match(/OPR\/(\d+)\./);
    if (!m) {
        return false;
    }
